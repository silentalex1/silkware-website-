...
const DonationApp = () => {
    ...
    return (
        <div className="relative z-10 min-h-screen flex flex-col pb-20">
            ...
            <main className="max-w-4xl mx-auto w-full px-6 pt-10 text-center">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    {devs.map((dev, idx) => (
                        <div key={idx} className="bg-card border border-white/5 p-8 rounded-[40px] flex flex-col items-center group relative overflow-hidden">
